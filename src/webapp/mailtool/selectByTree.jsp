...
<h:panelGroup style="margin-left:0em;width:auto;font-weight:normal">
			...
			<h:dataTable rendered="#{Mailtool.groupAwareRoleviewClicked}" value="#{Mailtool.recipientSelector_GroupAwareRole.dataModel}" var="row"  border="0" style="margin:0;width:100%" cellpadding="0" cellspacing="0">
			<h:column>
				...
				<h:dataTable value="#{Mailtool.recipientSelector_Group.dataModel}" var="grouprow"  border="0"  style="margin:0;width:auto" cellpadding="0" cellspacing="0">
					<h:column>
						...
						<h:panelGroup rendered="#{not grouprow.collapsed}">
							...
							<h:dataTable value="#{grouprow.userTable}" var="guser_row"  styleClass="listHier lines nolines hierItemBlockWrapper" columnClasses="attach,,attach,"  cellpadding="0" cellspacing="0" style="margin-left:2em;width:auto;font-weight:normal">
								<h:column>
				...
				<h:dataTable value="#{Mailtool.recipientSelector_Section.dataModel}" var="sectionrow"  border="0"  style="margin:0;width:auto" cellpadding="0" cellspacing="0">
					<h:column>
						...
						<h:panelGroup rendered="#{not sectionrow.collapsed}">
							...
							<h:dataTable value="#{sectionrow.userTable}" var="suser_row"  styleClass="listHier lines nolines hierItemBlockWrapper" columnClasses="attach,,attach,"  cellpadding="0" cellspacing="0" style="margin-left:2em;width:auto;font-weight:normal">
								<h:column>
