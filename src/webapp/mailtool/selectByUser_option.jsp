...
<%-- var=row is a SelectByUserTable.TableEntry      --%>
	...
	<h:panelGroup style="height:100%;overflow:hidden;display:block;margin:.5em 0;padding:.3em;color:#555 !important" styleClass="inopPanel" >
		...
		<h:dataTable value="#{Option.recipientSelector.dataModel}" var="row"  columnClasses="attach,,attach,"  cellpadding="0" cellspacing="0" style="width:auto;font-weight:normal" border="0" styleClass="listHier lines nolines"> 
			<h:column>
