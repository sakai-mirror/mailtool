...
<%-- Tree Table --%>
	...
	<h:panelGrid rendered="#{Option.groupviewClicked }" columns="1" styleClass="ListHier lines nolines hierItemBlockWrapper" style="margin-left:3em;width:auto">
				<h:dataTable value="#{Option.recipientSelector_Group.dataModel}" var="grouprow"  border="0"  style="margin:0;width:auto" cellpadding="0" cellspacing="0">
					<h:column>
	...
	<h:panelGrid rendered="#{Option.sectionviewClicked}" columns="1" styleClass="listHier lines nolines hierItemBlockWrapper" style="margin-left:3em;width:auto">
				<h:dataTable value="#{Option.recipientSelector_Section.dataModel}" var="sectionrow"  border="0"  style="margin:0;width:auto" cellpadding="0" cellspacing="0">
					<h:column>
